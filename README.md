...
این اصولی که گفتیم و پیاده‌سازی کردیم، باعث می‌شود که زمانی که بخواهیم یک روش پیام‌رسانی جدیدی به پروژه اضافه کنیم اصل OCP رعایت شود و نیازی به تغییر ساختار پیشین کد را نداشته باشیم؛ همچنین وابستگی قسمت‌های مختلف کد را کاهش دادیم تا اصل DIP را رعایت کرده باشیم و برای اضافه‌کردن قسمتی در کد، نیازی به تغییر دادن قسمت‌های دیگر نباشد. در ادامه با اصلاح نقض اصل LSP دیگر نیازی به override توابع با بدنه‌ی خالی‌ای که در کلاس جدید مورد نظر بی‌معنی هستند، نداریم. همچنین برای رعایت اصل ISP توابع و روابط تخصصی و کوچک‌تری تعریف کردیم که در نهایت با تلاش در رعایت تمامی این اصل‌ها، سعی کردیم این پروژه و کد را انعطاف‌پذیرتر، قابل نگه‌داری‌تر کنیم.
